...
!function () {
    ...
    var LobiboxBase = {
        $type: null, $el: null, $options: null, debug: function () {
            ...
            var me = this;
            me._triggerEvent("onShow"), me.$el.removeClass("lobibox-hidden"), $("body").append(me.$el);
            var firstBtn = me.$el.find(".lobibox-btn").first();
            return firstBtn.length > 0 && firstBtn[0].focus(), me.$options.modal && ($("body").addClass(Lobibox.base.OPTIONS.bodyClass), me._addBackdrop()), me._triggerEvent("shown"), me
        }
    };
